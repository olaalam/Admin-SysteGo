    ...
    },
{
                ...
                <div
                  ...
                  onClick={() => {
                    ...
                    if (!selectedIds.includes(prodId)) {
                      ...
                      toast.warning("This product is already in the bundle");
                    }
                  }}
                >
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-xs text-gray-400">Code: {p.prices?.[0]?.code || 'N/A'}</span>
                  </div>
                </div>
              ))}
            </div>
        ...
        {selectedProductsList.length > 0 && (
          <div className="mt-4 border rounded-lg bg-white overflow-hidden shadow-sm">
            <div className="bg-gray-50 px-4 py-2 border-b">
              <span className="text-xs font-bold text-gray-500 uppercase">Bundle Items ({selectedProductsList.length})</span>
            </div>
  ...
  const handleSubmit = async (formData) => {
    ...
    if(!formData.productsId || formData.productsId.length === 0) {
        toast.error("Please select at least one product for the Pandel.");
        return;
    }
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <AddPage
        ...
        description="Bundle multiple products together into a Pandel"
        fields={fields}
