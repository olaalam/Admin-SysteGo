    ...
    return (
      <div className="border border-gray-300 rounded bg-white shadow-sm p-2 flex flex-col items-center justify-center text-center overflow-hidden" style={getPreviewStyle()}>
        {labelConfig.showBusinessName && (
          <div className="font-bold uppercase tracking-tighter leading-none mb-1 text-gray-800" style={{ fontSize: `${labelConfig.businessNameSize}px` }}>
            {businessName}
          </div>
        )}
        {labelConfig.showProductName && (
          <div className="font-medium leading-none mb-1 line-clamp-1" style={{ fontSize: `${labelConfig.productNameSize}px` }}>
            {product.productName}
          </div>
        )}
        ...
        {labelConfig.showPrice && (
          <div className="font-black" style={{ fontSize: `${labelConfig.priceSize}px` }}>
            {product.price} EGP
          </div>
        )}
      </div>
    ...
    <div className="min-h-screen bg-gray-50 p-6" dir="ltr">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-6 border border-gray-100">
          ...
          <div className="mb-6">
            <label className="block text-sm font-bold text-gray-700 mb-2">Search or Scan Product</label>
